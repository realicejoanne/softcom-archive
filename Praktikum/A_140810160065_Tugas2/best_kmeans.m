...
% referensi : https://www.mathworks.com/matlabcentral/fileexchange/49489-best_kmeans-x
...
% After find the best K clusters, IDX,C,SUMD are determined using kmeans function in matlab.
dim=size(X);
